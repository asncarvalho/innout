...
class User extends Model {
    ...
    private function validate(){
        ...
        if(!$this->start_date){
            $errors['start_date'] = 'Data de início é um campo obrigatório';
        }elseif(!DateTime::createFromFormat('Y-m-d', $this->start_date)){
            $errors['start_date'] = 'Data de início deve seguir o padrão dd/mm/aaaa';
        }
        ...
        if(!$this->confirm_password){
            $errors['confirm_password'] = 'Confirmação da senha é um campo obrigatório';
        }
